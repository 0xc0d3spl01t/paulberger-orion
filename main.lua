...
function Orion:CreateOrion(orionName)
    ...
    StartupFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 15)
    StartupFrame.BorderSizePixel = 0
    StartupFrame.Position = UDim2.new(0.5, -200, 0.5, -200)
    StartupFrame.Size = UDim2.new(0, 400, 0, 400)
    
    StartupCorner.CornerRadius = UDim.new(0, 10)
    StartupCorner.Parent = StartupFrame
    
    StartupImage.Name = "StartupImage"
    StartupImage.Parent = StartupFrame
    StartupImage.BackgroundTransparency = 1
    StartupImage.Position = UDim2.new(0.05, 0, 0.05, 0)
    StartupImage.Size = UDim2.new(0.9, 0, 0.9, 0)
    StartupImage.Image = "https://pipah.de/media/image/product/17261/lg/paulberger-limo-bubblegum-330ml.jpg"
    StartupImage.ScaleType = Enum.ScaleType.Fit
    
    -- Background Music
    local Sound = Instance.new("Sound")
    Sound.Parent = game.CoreGui
    Sound.SoundId = "https://files.catbox.moe/0woe8w.mp3"
    Sound.Volume = 0.5
    Sound.Looped = true
    Sound:Play()
    
    -- Fade out startup screen after 3 seconds
    wait(3)
    for i = 1, 10 do
        StartupFrame.BackgroundTransparency = i / 10
        StartupImage.ImageTransparency = i / 10
        wait(0.05)
    end
    StartupGui:Destroy()
    ...
    MainWhiteFrame.BackgroundColor3 = Color3.fromRGB(0, 100, 200) -- Blau
    ...
    tabFrame.Size = UDim2.new(0, 100, 0, 284) -- Reduced size for footer
    ...
    -- Footer Label "PAULBERGER QUALITÄT"
    footerLabel.Name = "footerLabel"
    footerLabel.Parent = MainWhiteFrame_2
    footerLabel.BackgroundColor3 = Color3.fromRGB(20, 80, 160) -- Dunkleres Blau
    footerLabel.BorderSizePixel = 0
    footerLabel.Position = UDim2.new(0, 0, 0.918, 0)
    footerLabel.Size = UDim2.new(0, 100, 0, 25)
    footerLabel.Font = Enum.Font.GothamBold
    footerLabel.Text = "PAULBERGER\nQUALITÄT"
    ...
    header.BackgroundColor3 = Color3.fromRGB(30, 120, 220) -- Blau
    ...
    function SectionHandler:CreateSection(secName)
        ...
        newPage.ScrollBarImageColor3 = Color3.fromRGB(30, 120, 220) -- Blau
        ...
        tabBtn.MouseButton1Click:Connect(function()
            ...
            game.TweenService:Create(tabBtn, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),{
                BackgroundColor3 = Color3.fromRGB(0, 100, 200) -- Blau
            }):Play()
        end)
        ...
        function ElementHandler:TextButton(buttonText, buttonInfo, callback)
            ...
            TextButton.BackgroundColor3 = Color3.fromRGB(30, 120, 220) -- Blau
            ...
            function ElementHandler:Toggle(togInfo, callback)
                ...
                toggleInerFrame.BackgroundColor3 = Color3.fromRGB(30, 120, 220) -- Blau
                ...
                toggleBtn.MouseButton1Click:Connect(function()
                    ...
                    if toggled then
                        game.TweenService:Create(toggleBtn, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),{
                            BackgroundColor3 = Color3.fromRGB(30, 120, 220) -- Blau
                        }):Play()
                    else
                        game.TweenService:Create(toggleBtn, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),{
                            BackgroundColor3 = Color3.fromRGB(25,25,25)
                ...
                function ElementHandler:Slider(sliderin, minvalue, maxvalue, callback)
                    ...
                    sliderValue.TextColor3 = Color3.fromRGB(50, 150, 255) -- Hellblau
                    ...
                    sliderMainFrm.BackgroundColor3 = Color3.fromRGB(30, 120, 220) -- Blau
                    sliderMainFrm.BorderColor3 = Color3.fromRGB(30, 120, 220)
                    ...
                    local mouse = game.Players.LocalPlayer:GetMouse()
                        ...
                        function ElementHandler:KeyBind(keInfo, firstt, callback)
                            ...
                            function ElementHandler:TextBox(textInfo, placeHolderText1, callback)
                                ...
                                texboxInner.BackgroundColor3 = Color3.fromRGB(30, 120, 220) -- Blau
                                ...
                                function ElementHandler:Dropdown(dInfo, list, callback)
                                    ...
                                    dropdownItem.TextColor3 = Color3.fromRGB(50, 150, 255) -- Hellblau
                                    ...
                                    ImageButton.ImageColor3 = Color3.fromRGB(30, 120, 220) -- Blau
                                    ...
                                    for i,v in next, list do
                                        ...
                                        optionBtn.BackgroundColor3 = Color3.fromRGB(10, 80, 160) -- Dunkleres Blau
